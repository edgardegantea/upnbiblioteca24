...
<head>
    ...
    <title>Actualiza tu perfil de usuario</title>
...
<div class="container">
    ...
    <form class="row g-3 needs-validation" action="/update-profile" method="post" novalidate>
        <div class="col-md-6">
        ...
        <div class="col-md-6">
            ...
            <div class="row g-2">
                <div class="col-md-6">
                    <input type="text" name="apaterno" placeholder="Paterno" class="form-control"
                ...
                <div class="col-md-6">
                    <input type="text" name="amaterno" placeholder="Materno" class="form-control"
        ...
        <div class="col-md-6">
            ...
            <div class="invalid-feedback">
                El nombre de usuario debe tener al menos 5 caracteres y no contener espacios.
            </div>
        </div>
...
<script>
    ...
    // Agregar event listeners para ejecutar las funciones de validación al cambiar el valor de los inputs
