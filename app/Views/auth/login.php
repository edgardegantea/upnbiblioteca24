...
<head>
    ...
    <meta name="description" content="Biblioteca UPN212">
    <meta name="author" content="Edgar Degante-A">
    <meta name="generator" content="Edgar Degante-A">
    <title>Login</title>
    ...
    <main class="form-signin w-100 m-auto text-center">
        ...
        <form action="/login" method="post">
            ...
            <div class="form-floating">
                <input type="text" class="form-control" id="floatingInput" name="username_or_email" required>
