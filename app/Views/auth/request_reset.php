...
<div class="container d-flex justify-content-center align-items-center min-vh-100">
    <div class="" style="width: 400px;">
        <div class="card-body">
            ...
            <form action="/reset-password" method="post" class="text-center">
                <?= csrf_field() ?>
                <div class="mb-3">
        ...
        <div class="mt-4 card text-center">
            <span class="card-body bg-body-tertiary text-primary">Revise la bandeja de su correo electrónico para continuar con el proceso de restablecimiento de contraseña.</span>
        </div>
    </div>
</div>
